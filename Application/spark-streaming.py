...
if __name__ == "__main__":
 ...
 # Spark-Kafka integration
             .config("spark.jars",
r"C:\Users\Ultapc\Downloads\Compressed\realtime-voting-data-engineering-main_2\realtime-voting-data-engineering-main\postgresql-42.7.1.jar")  # PostgreSQL driver
             .config("spark.sql.adaptive.enabled", "false")  # Désactiver l'exécution de requête adaptative
             .getOrCreate())
 ...
 # PostgreSQL driver
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", r"C:\Users\Ultapc\Downloads\Compressed\realtime-voting-data-engineering-main_2\realtime-voting-data-engineering-main\checkpoints\checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation",r"C:\Users\Ultapc\Downloads\Compressed\realtime-voting-data-engineering-main_2\realtime-voting-data-engineering-main\checkpoints\checkpoint2") \
        .outputMode("update") \
        .start()
